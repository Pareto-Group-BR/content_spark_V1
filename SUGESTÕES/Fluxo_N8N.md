...
Claro! Aqui está um índice para sua documentação, formatado para funcionar com os links de âncora do Github:
...
*   [3. Detalhamento do Fluxo por Fases](#3-detalhamento-do-fluxo-por-fases)
    *   [FASE 1: Ativação e Coleta de Dados](#fase-1-ativação-e-coleta-de-dados)
        *   [Nó 1: `Webhook`](#nó-1-webhook)
        *   [Nó 2: `Get row(s) in sheet`](#nó-2-get-rows-in-sheet)
        *   [Nó 3: `Filter1`](#nó-3-filter1)
    *   [FASE 2: Pesquisa Aprofundada](#fase-2-pesquisa-aprofundada)
        *   [Nó 4: `Pré Pesquisa Aprofundada1`](#nó-4-pré-pesquisa-aprofundada1)
        *   [Nó 5: `TESS - Agente de Pesquisa Aprofundada - Gerar temas1`](#nó-5-tess---agente-de-pesquisa-aprofundada---gerar-temas1)
        *   [Nó 6: `TESS - Agente de Pesquisa Aprofundada - Aprofundar1`](#nó-6-tess---agente-de-pesquisa-aprofundada---aprofundar1)
        *   [Nó 7: `Wait 60s1`](#nó-7-wait-60s1)
        *   [Nó 8: `GET | TESS - Agente Identificador de Tendências2`](#nó-8-get--tess---agente-identificador-de-tendências2)
    *   [FASE 3: Criação de Roteiro](#fase-3-criação-de-roteiro)
        *   [Nó 9: `Pós Pesquisa Aprofundada`](#nó-9-pós-pesquisa-aprofundada)
        *   [Nó 10: `TESS - Criador de Roteiro de Post Instagram`](#nó-10-tess---criador-de-roteiro-de-post-instagram)
        *   [Nó 11: `Wait 30s1`](#nó-11-wait-30s1)
        *   [Nó 12: `GET | TESS - Agente Criador Carrosséis Instagram`](#nó-12-get--tess---agente-criador-carrosséis-instagram)
    *   [FASE 4: Geração Visual](#fase-4-geração-visual)
        *   [Nó 13: `Pós criação de roteiro`](#nó-13-pós-criação-de-roteiro)
        *   [Nó 14: `TESS - Agente Criador Carrosséis Instagram [FUNDO]`](#nó-14-tess---agente-criador-carrosséis-instagram-fundo)
        *   [Nó 15: `Wait 45s` + Nó 16: `GET Imagens Fundo`](#nó-15-wait-45s--nó-16-get-imagens-fundo)
        *   [Nó 17: `JSON Parse3`](#nó-17-json-parse3)
        *   [Nó 18: `TESS - Criar anúncios de Imagem em HTML`](#nó-18-tess---criar-anúncios-de-imagem-em-html)
        *   [Nó 19: `Wait 45s` + Nó 20: `GET HTML`](#nó-19-wait-45s--nó-20-get-html)
        *   [Nó 21: `Dados do conteúdo1`](#nó-21-dados-do-conteúdo1)
    *   [FASE 5: Armazenamento e Processamento de Artes](#fase-5-armazenamento-e-processamento-de-artes)
        *   [Nó 22: `Create folder1`](#nó-22-create-folder1)
        *   [Nó 23: `Dividir saída em arquivos HTML diferentes1`](#nó-23-dividir-saída-em-arquivos-html-diferentes1)
        *   [Nó 24: `Loop Over Items2`](#nó-24-loop-over-items2)
        *   [Nó 25: `Gerar imagem pelo HTML1`](#nó-25-gerar-imagem-pelo-html1)
        *   [Nó 26: `Baixar imagem`](#nó-26-baixar-imagem)
        *   [Nó 27: `Subir imagem no drive`](#nó-27-subir-imagem-no-drive)
        *   [Nó 28: `Wait6`](#nó-28-wait6)
    *   [FASE 6: Atualização e Notificação](#fase-6-atualização-e-notificação)
        *   [Nó 29: `Atualizar planilha`](#nó-29-atualizar-planilha)
        *   [Nó 30: `Send a message1`](#nó-30-send-a-message1)
        *   [Nó 31: `Enviar Mensagem Gchat`](#nó-31-enviar-mensagem-gchat)
